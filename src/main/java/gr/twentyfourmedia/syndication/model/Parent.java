...
public class Parent {
	...
	/**
	 * The id of the parent section. If this attribute is specified, a section element with an
	 * id attribute that matches this attribute must appear somewhere before this parent
	 * element in the syndication file. The referenced section element must have its mirror-source
	 * attribute set to true. If dbid or source and sourceid are specified, then this attribute is ignored.
	 */
	@XmlAttribute(name = "id-ref")
	private String idRef;
	
	/**
	 * The source of the parent section. If this attribute is specified, then sourceid must also
	 * be specified. One of the following two conditions must be satisfied:
	 ...
	 * 		2) A section element with source and sourceid attributes that match source and sourceid 
	 * 		must appear somewhere before this parent element in the syndication file. The referenced 
	 * 		section element must have its mirror-source attribute set to true.
	...
	/**
	 * The dbid of the parent section. If this attribute is specified then one of the following two
	 ...
	 * 		2) A section element with a dbid attribute that matches this attribute must appear
	 * 		somewhere before this parent element in the syndication file. The referenced section 
	 * 		element must have its mirror-source attribute set to true.
	 * This attribute is never present in syndication files that have been exported from a database. 
	 * IDs are always written to exported-dbid attributes in exported syndication files.
	 */
	...
	/**
	 * The unique-name or name of the parent section. If this attribute is specified, then one of
	...
	/**
	 * If set to false then the section will not inherit the access control list of the parent
	 * section, and the section will maintain its own access control list.
	 */
